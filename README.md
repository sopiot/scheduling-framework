...
- **Simulation Data file**
  ...
  A file that stores the simulation data generated by the simulation generator. The simulation can be replicated using only this file. More information can be found [here](#simulation-data-file).
...
This section explains the format of the configuration files used by the IoT simulator, including the **Device Pool file**, **Simulation Environment file**, **Manual Middleware Tree file**, **Scheduling Algorithm file**, **Simulation Data file**. Each file is described using the following format for each element:

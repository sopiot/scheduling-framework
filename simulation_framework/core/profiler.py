...
LOG_ORDER_MAP = {
    ProfileType.SCHEDULE: {
        MXProtocolType.Super.CP_SCHEDULE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Super.MS_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
        MXProtocolType.Super.MS_SCHEDULE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Super.MS_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Super.SM_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING_INNER},
        ],
        MXProtocolType.Super.SM_SCHEDULE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.SM_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
        'fill it': [],
        MXProtocolType.Super.CP_RESULT_SCHEDULE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_SCHEDULE, 'overhead_type': OverheadType.TARGET_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
        MXProtocolType.Super.MS_RESULT_SCHEDULE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Super.MS_RESULT_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Super.SM_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING_INNER},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Super.SM_RESULT_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING_INNER},
        ],
        MXProtocolType.Super.SM_RESULT_SCHEDULE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.SM_RESULT_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_RESULT_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
        MXProtocolType.Super.PC_RESULT_SCHEDULE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_RESULT_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_RESULT_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
    },
    ProfileType.EXECUTE: {
        MXProtocolType.Super.CP_EXECUTE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.MS_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
        MXProtocolType.Super.MS_EXECUTE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Super.MS_EXECUTE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Super.SM_EXECUTE, 'overhead_type': OverheadType.SUPER_THING_INNER},
        ],
        MXProtocolType.Super.SM_EXECUTE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.SM_EXECUTE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
        MXProtocolType.Super.PC_EXECUTE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Base.MT_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
        MXProtocolType.Base.MT_EXECUTE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Base.MT_EXECUTE, 'overhead_type': OverheadType.TARGET_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Base.TM_RESULT_EXECUTE, 'overhead_type': OverheadType.TARGET_THING_INNER},
        ],
        MXProtocolType.Base.TM_RESULT_EXECUTE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Base.TM_RESULT_EXECUTE, 'overhead_type': OverheadType.TARGET_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
        MXProtocolType.Super.CP_RESULT_EXECUTE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.MS_RESULT_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
        MXProtocolType.Super.MS_RESULT_EXECUTE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Super.MS_RESULT_EXECUTE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Super.SM_EXECUTE, 'overhead_type': OverheadType.SUPER_THING_INNER},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.THING, 'protocol': MXProtocolType.Super.SM_RESULT_EXECUTE, 'overhead_type': OverheadType.SUPER_THING_INNER},
        ],
        MXProtocolType.Super.SM_RESULT_EXECUTE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.SM_RESULT_EXECUTE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_RESULT_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
        MXProtocolType.Super.PC_RESULT_EXECUTE: [
            {'direction': Direction.RECEIVED, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_RESULT_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            {'direction': Direction.PUBLISH, 'element_type': MXElementType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_RESULT_EXECUTE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
        ],
    }
}
...
class LogLine:
    def __init__(self, timestamp: str, raw_log_data: str, get_topic_func: Callable, get_payload_func: Callable, element_type: MXElementType, element_name: str) -> None:
        ...
        self.protocol = MXProtocolType.get(self.topic) if self.topic else None
...
class Profiler:
    ...
    def init(self, root_log_folder_path: str):
        ...
        MXLOG_DEBUG(f'Load simulation log from {root_log_folder_path} successfully', 'green')
    ...
    def make_middleware_log(self, path: str) -> MiddlewareLog:
        ...
        for file in file_list:
            ...
            MXLOG_DEBUG(f'Generate MiddlewareLog of middleware {middleware_log.log_data.element_name} from {file}', 'green')
    ...
    def make_thing_log_list(self, path: str) -> List[ThingLog]:
        ...
        for file in file_list:
            ...
            MXLOG_DEBUG(f'Generate MiddlewareLog of middleware {thing_log.log_data.element_name} from {file}', 'green')
    ...
    def collect_request_start_log_list(self, super_service: str, profile_type: ProfileType) -> List[LogLine]:
        ...
        for log_line in self.integrated_mqtt_msg_log_list:
            if log_line.protocol != start_protocol:
                continue
            if log_line.element_type != MXElementType.MIDDLEWARE:
                continue
        ...
        if len(request_start_log_list) == 0:
            MXLOG_DEBUG(f"Cannot find super service start log for {super_service}", 'yellow')
            return []
    ...
    def collect_target_start_log_list(self, target_service: str, request_log_list: List[LogLine], profile_type: ProfileType) -> List[LogLine]:
        ...
        for log_line in request_log_list:
            if log_line.protocol != start_protocol:
                continue
            if log_line.element_type != MXElementType.THING:
                continue
    ...
    def profile_request(self, request_log_list: List[LogLine], profile_type: ProfileType) -> Overhead:
        ...
        for i, log_line in enumerate(request_log_list[:-1]):
            ...
            if curr_log_line.protocol == MXProtocolType.Super.SM_SCHEDULE:
                ...
                if not overhead_type:
                    ...
                    overhead_type = self.check_next_log_valid(curr_log_line=curr_log_line, next_log_line=next_log_line, profile_type=profile_type)
                else: # 2023/05/16 23:22:36.811997
        ...
        MXLOG_DEBUG(f'Profile request: {request_log_list[0].request_key} complete!', 'yellow')
        MXLOG_DEBUG(f'=== Result=== \n{str(request_overhead)}', 'green')
    ...
    def is_request_end(self, log_line: LogLine) -> bool:
        return log_line.protocol in SM_RESULT_PROTOCOL and log_line.element_type == MXElementType.MIDDLEWARE

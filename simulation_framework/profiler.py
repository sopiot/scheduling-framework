...
SCHEDULE_PROTOCOL = [MXProtocolType.Super.MS_SCHEDULE,
                     MXProtocolType.Super.CP_SCHEDULE,
...
MS_PROTOCOL = [MXProtocolType.Super.MS_SCHEDULE, MXProtocolType.Super.MS_EXECUTE]
MS_RESULT_PROTOCOL = [MXProtocolType.Super.MS_RESULT_SCHEDULE, MXProtocolType.Super.MS_RESULT_EXECUTE]
SM_PROTOCOL = [MXProtocolType.Super.SM_SCHEDULE, MXProtocolType.Super.SM_EXECUTE]
SM_RESULT_PROTOCOL = [MXProtocolType.Super.SM_RESULT_SCHEDULE, MXProtocolType.Super.SM_RESULT_EXECUTE]
CP_PROTOCOL = [MXProtocolType.Super.CP_SCHEDULE, MXProtocolType.Super.CP_EXECUTE]
CP_RESULT_PROTOCOL = [MXProtocolType.Super.CP_RESULT_SCHEDULE, MXProtocolType.Super.CP_RESULT_EXECUTE]
PC_PROTOCOL = [MXProtocolType.Super.PC_SCHEDULE, MXProtocolType.Super.PC_EXECUTE]
PC_RESULT_PROTOCOL = [MXProtocolType.Super.PC_RESULT_SCHEDULE, MXProtocolType.Super.PC_RESULT_EXECUTE]
...
class Overhead:
    ...
    Args:
        ...
        component_type_from (MXComponentType, optional): _description_. Defaults to None.
        level_from (int, optional): _description_. Defaults to None.
        protocol_from (MXProtocolType, optional): _description_. Defaults to None.
        component_name_to (str, optional): _description_. Defaults to None.
        component_type_to (MXComponentType, optional): _description_. Defaults to None.
        level_to (int, optional): _description_. Defaults to None.
        protocol_to (MXProtocolType, optional): _description_. Defaults to None.
    """

    def __init__(self, duration: timedelta = timedelta(), overhead_type: OverheadType = None,
                 component_name_from: str = None, component_type_from: MXComponentType = None, level_from: int = None, protocol_from: MXProtocolType = None,
                 component_name_to: str = None, component_type_to: MXComponentType = None, level_to: int = None, protocol_to: MXProtocolType = None) -> None:
        self.duration: timedelta = duration
        self.type: OverheadType = overhead_type
        self.component_name_from: str = component_name_from
        self.component_type_from: MXComponentType = component_type_from
        self.protocol_from: MXComponentType = protocol_from
        self.level_from: int = level_from
        self.component_name_to: str = component_name_to
        self.component_type_to: MXComponentType = component_type_to
        self.protocol_to: MXComponentType = protocol_to
...
LOG_ORDER_MAP = {
    ProfileType.SCHEDULE: {
        MXProtocolType.Super.CP_SCHEDULE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Super.MS_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            ],
        },
        MXProtocolType.Super.MS_SCHEDULE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Super.SM_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Super.MS_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            ],
        },
        MXProtocolType.Super.SM_SCHEDULE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.SM_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            ],
        },
        MXProtocolType.Super.CP_RESULT_SCHEDULE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_SCHEDULE, 'overhead_type': OverheadType.TARGET_THING__MIDDLEWARE_COMM},
            ],
        },
        MXProtocolType.Super.MS_RESULT_SCHEDULE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Super.SM_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING_INNER},
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Super.SM_RESULT_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Super.MS_RESULT_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            ],
        },
        MXProtocolType.Super.SM_RESULT_SCHEDULE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_RESULT_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.SM_RESULT_SCHEDULE, 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            ],
        },
        MXProtocolType.Super.PC_RESULT_SCHEDULE: {
            Direction.RECEIVED: [
            ...
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_RESULT_SCHEDULE, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            ],
        }
    },
    ProfileType.EXECUTE: {
        MXProtocolType.Super.CP_EXECUTE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_EXECUTE,
                 'level_change': None, 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.MS_EXECUTE,
                 'level_change': None, 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_EXECUTE,
                 'level_change': 'up', 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            ],
        },
        MXProtocolType.Super.MS_EXECUTE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Super.SM_EXECUTE,
                 'level_change': None, 'component_change': None, 'overhead_type': OverheadType.SUPER_THING_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Super.MS_EXECUTE,
                 'level_change': None, 'component_change': (MXComponentType.MIDDLEWARE, MXComponentType.THING), 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            ]
        },
        MXProtocolType.Super.SM_EXECUTE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_EXECUTE,
                 'level_change': None, 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.SM_EXECUTE,
                 'level_change': None, 'component_change': (MXComponentType.THING, MXComponentType.MIDDLEWARE), 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            ]
        },
        MXProtocolType.Super.PC_EXECUTE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_EXECUTE,
                 'level_change': None, 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Base.MT_EXECUTE,
                 'level_change': None, 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_EXECUTE,
                 'level_change': 'down', 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            ]
        },
        MXProtocolType.Base.MT_EXECUTE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Base.TM_RESULT_EXECUTE,
                 'level_change': None, 'component_change': None, 'overhead_type': OverheadType.TARGET_THING_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Base.MT_EXECUTE,
                 'level_change': None, 'component_change': (MXComponentType.MIDDLEWARE, MXComponentType.THING), 'overhead_type': OverheadType.TARGET_THING__MIDDLEWARE_COMM},
            ]
        },
        MXProtocolType.Base.TM_RESULT_EXECUTE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_EXECUTE,
                 'level_change': None, 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Base.TM_RESULT_EXECUTE,
                 'level_change': None, 'component_change': (MXComponentType.THING, MXComponentType.MIDDLEWARE), 'overhead_type': OverheadType.TARGET_THING__MIDDLEWARE_COMM},
            ]
        },
        MXProtocolType.Super.CP_RESULT_EXECUTE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_EXECUTE,
                 'level_change': None, 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.MS_RESULT_EXECUTE,
                    'level_change': None, 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.CP_RESULT_EXECUTE,
                 'level_change': 'up', 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            ]
        },
        MXProtocolType.Super.MS_RESULT_EXECUTE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Super.SM_EXECUTE,
                 'level_change': None, 'component_change': None, 'overhead_type': OverheadType.SUPER_THING_INNER},
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Super.SM_RESULT_EXECUTE,
                    'level_change': None, 'component_change': None, 'overhead_type': OverheadType.SUPER_THING_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.THING, 'protocol': MXProtocolType.Super.MS_RESULT_EXECUTE,
                 'level_change': None, 'component_change': (MXComponentType.MIDDLEWARE, MXComponentType.THING), 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            ]
        },
        MXProtocolType.Super.SM_RESULT_EXECUTE: {
            Direction.RECEIVED: [
                {'direction': Direction.PUBLISH, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_RESULT_EXECUTE,
                 'level_change': None, 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE_INNER},
            ],
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.SM_RESULT_EXECUTE,
                 'level_change': None, 'component_change': (MXComponentType.THING, MXComponentType.MIDDLEWARE), 'overhead_type': OverheadType.SUPER_THING__MIDDLEWARE_COMM},
            ]
        },
        MXProtocolType.Super.PC_RESULT_EXECUTE: {
            ...
            Direction.PUBLISH: [
                {'direction': Direction.RECEIVED, 'component_type': MXComponentType.MIDDLEWARE, 'protocol': MXProtocolType.Super.PC_RESULT_EXECUTE,
                 'level_change': 'down', 'component_change': None, 'overhead_type': OverheadType.MIDDLEWARE__MIDDLEWARE_COMM},
            ]
        }
    }
...
class LogLine:
    ...
    Args:
        ...
        protocol (MXProtocolType): MQTT packet's protocol. Refer to the MXIoT protocol specification document for this information. 
                                    `None` if there is no mqtt packet.
        component_name (str): Log device's name.
        component_type (MXComponentType): Log device's type. Either THING or MIDDLEWARE.
        level (int): Log device's level.
    """

    def __init__(self, timestamp: datetime, raw_log_data: str, topic: str, payload: str, direction: Direction, protocol: MXProtocolType,
                 component_name: str, component_type: MXComponentType, level: int) -> None:
        self.raw_log_data: str = raw_log_data
        self.component_name: str = component_name
        self.component_type: MXComponentType = component_type
...
class ComponentLog(metaclass=ABCMeta):
    ...
    def get_protocol(self, topic: str) -> MXProtocolType:
...
class MiddlewareLog(ComponentLog):
    def __init__(self, level: int, component_name: str, device: str) -> None:
        ...
        self.component_type = MXComponentType.MIDDLEWARE
...
class Profiler:
    ...
    def load(self, log_root_path: str = '') -> 'Profiler':
        ...
        MXLOG_DEBUG(f'Load simulation log from {log_root_path} successfully', 'green')
        return self
    ...
    def collect_request_start_log_line(self, profile_type: ProfileType) -> List[LogLine]:
        ...
        for log_line in self.integrated_mqtt_log:
            if log_line.protocol != start_protocol:
                continue
            if log_line.component_type != MXComponentType.MIDDLEWARE:
                continue
        ...
        if len(request_start_log_line_list) == 0:
            MXLOG_DEBUG(f"Cannot find request start log!!!", 'red')
    ...
    def collect_log_line_by_request(self, super_service_start_log: LogLine, profile_type: ProfileType) -> Union[List[LogLine], bool]:
        ...
        for log_line in log_line_in_target_range:
            ...
            MXTEST_LOG_DEBUG(f'[DEBUG] request_key_check: {log_line.request_key != super_service_start_log.request_key} {log_str}', 'yellow')
    ...
    def collect_target_start_log_line(self, target_service: str, request_log_list: List[LogLine], profile_type: ProfileType) -> List[LogLine]:
        if profile_type == ProfileType.SCHEDULE:
            start_protocol = MXProtocolType.Super.SM_SCHEDULE
        elif profile_type == ProfileType.EXECUTE:
            start_protocol = MXProtocolType.Super.SM_EXECUTE
        else:
            raise TypeError(f"Invalid profile type: {profile_type}")
        ...
        for log_line in request_log_list:
            if log_line.protocol != start_protocol:
                continue
            if log_line.component_type != MXComponentType.THING:
                continue
        ...
        if len(target_start_log_list) == 0:
            MXLOG_DEBUG(f"Cannot find target start log for {target_service}", 'yellow')
            return []

        return target_start_log_list

    def is_request_end(self, log_line: LogLine) -> bool:
        return log_line.protocol in SM_RESULT_PROTOCOL and log_line.component_type == MXComponentType.MIDDLEWARE

    def is_sub_request_end(self, log_line: LogLine) -> bool:
        return log_line.protocol in MS_RESULT_PROTOCOL and log_line.component_type == MXComponentType.THING
    ...
    def get_overhead_type_if_valid(self, curr_log_line: LogLine, next_log_line: LogLine, profile_type: ProfileType) -> OverheadType:
        if curr_log_line == next_log_line:
            MXTEST_LOG_DEBUG(f'[DEBUG] Same log line: {curr_log_line}', 'yellow')
            return False
